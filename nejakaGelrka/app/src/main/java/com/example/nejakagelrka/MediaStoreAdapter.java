package com.example.nejakagelrka;
...
public class MediaStoreAdapter extends RecyclerView.Adapter<MediaStoreAdapter> {
    ...
    @Override
    public void onBindViewHolder(@NonNull MediaStoreAdapter holder, int position, @NonNull List<Object> payloads) {
